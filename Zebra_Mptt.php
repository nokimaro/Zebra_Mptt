...
class Zebra_Mptt
{
     ...
     * @return void
     */
    public function __construct(&$link, $table_name = 'mptt', $id_column = 'id', $title_column = 'title', $left_column = 'lft', $right_column = 'rgt', $parent_column = 'parent', $filter_column = false, $filter_value = false)
    {
    ...
    public function get_path($node)
    {
        ...
        $parents[$node] = isset($this->lookup[$node]) ? $this->lookup[$node] : null;
